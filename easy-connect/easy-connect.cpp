...
#include "W5500Interface/W5500Interface.h"
W5500Interface eth(W5500_SPI_MOSI,W5500_SPI_MISO,W5500_SPI_SCLK, W5500_SPI_CS, W5500_SPI_RST); // mosi, miso, sclk, cs, reset
...
#include "nsapi_dns.h"
*/
#elif MBED_CONF_APP_NETWORK_INTERFACE == ETHERNET_W7500x

#include "WIZnetInterface/WIZnetInterface.h"
WIZnetInterface eth;

#include "WIZnetInterface/DHCPClient/DHCPClient.h"
DHCPClient dhcp;
 
/*
#include "WIZnetInterface/DNSClient/DNSClient.h"
DNSClient  dns;
#include "nsapi_dns.h"
*/
#else
...
#elif (MBED_CONF_APP_NETWORK_INTERFACE == ETHERNET_W5500) || (MBED_CONF_APP_NETWORK_INTERFACE == ETHERNET_W7500x)
...
#elif MBED_CONF_APP_NETWORK_INTERFACE == ETHERNET_W7500x
    if (log_messages) {
        printf("[EasyConnect] Ethernet W7500x\n");
    }
    return &eth;
